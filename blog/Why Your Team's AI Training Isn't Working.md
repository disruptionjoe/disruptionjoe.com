...
Thanks for reading Disruption's Substack! Subscribe for free to receive new posts and support my work.
...
Collective decision-making, open participatory systems, the challenge of building structures where quieter voices carry real weight: these are the things that fuel my professional passion and [purpose](https://www.disruptionjoe.com/blog/accelerating-collaboration.html).
...
The [AI Activations Playbook](https://www.disruptionjoe.com/playbook/) is a modular facilitation system: 8 session arcs, 30 plays, 31 moves, and growing.
...
- **Friction to Opportunity** takes a team from real workflow pain points into a concrete map of AI-relevant possibilities.
    
- **Concern to Confidence** moves a cautious or skeptical room toward grounded engagement.
    
- **Exploration to Commitment** takes broad curiosity and shapes it into explicit priorities and owned next steps.
...
- **Friction Harvest** pulls real workflow annoyances, breakdowns, and repetitive tasks into the room in a structured way.
    
- **Trust and Privacy Readiness Assessment** surfaces the specific concerns that are actually shaping whether people engage or hold back.
    
- **Opportunity Clustering** takes the raw ideas a team generates and organizes them into clearer themes.
    

> **MOVES** are the AI-first interactive mechanics inside the plays, and this is where the facilitation craft lives.

- **Private-to-Shared** means people work individually first, then bring stronger thinking into the group, so the loudest voice does not set the frame before everyone else has had a chance to think.
    
- **Build-and-Compare** has groups respond to the same challenge, then compare outputs side by side, which surfaces differences in assumptions that would stay hidden in a normal discussion.
    
- **Human-AI Draft Pick** puts both human and AI-generated material on the table, and the room selects, critiques, remixes, and improves what is strongest. Prompt Crazy 8s is exactly as fun as it sounds.
...
## This Substack going forward

Here, I’ll share what I’m learning as I build, facilitate, and work with AI in practice.  
...
The [team sessions are live now](https://disruptionjoe.com/).
