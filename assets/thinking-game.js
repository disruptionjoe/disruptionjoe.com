  ...
  var exhibits = [
    {
      ...
      staticTitle: "See how Joe keeps pushing the frontier",
      purpose: "Joe uses his own agent systems and repositories as a working testbed, studying how context, instructions, memory, tools, review, and human judgment change what AI can reliably do. This ongoing research is the learning engine behind Capability Acceleration.",
      mobileCardLabel: "Supporting System / Learning",
      dynamicTitle: "Follow the experiments behind better agent performance",
      passion: "AI Epistemology turns everyday operating experience into questions Joe can test: what improved the result, what failed, what transferred, and what only worked once. Those lessons help him strengthen current systems and explore harder, higher-value work without confusing novelty with reliable capability.",
    ...
    },
    {
      ...
      staticTitle: "Turn what works into methods others can use",
      purpose: "AI Activation Playbooks capture learning from all three capabilities, client work, and experimentation. They organize that knowledge into methods, session arcs, plays, moves, and reusable assets that people and teams can apply to real work.",
      mobileCardLabel: "Supporting System / Transfer",
      dynamicTitle: "See how useful knowledge becomes transferable",
      passion: "Inside the Playbook, you can inspect how Joe structures a room, sequences hands-on work, and turns lessons into reusable guidance. The Playbooks keep evolving as client work and experimentation reveal what helps people learn, decide, operate, and improve.",
    ...
    },
    {
      ...
      staticTitle: "Map the path from AI use to business value",
      purpose: "The AI Enablement Architecture makes the path from individual use to team practice and enterprise results visible. It maps prerequisites, path dependencies, evidence, and the conditions required for progress to become consistent, measurable, scalable, and tied to business value.",
      mobileCardLabel: "Supporting System / Path",
      dynamicTitle: "See what your organization is ready to build next",
      passion: "Explore 12 connected capabilities across individual, team, and enterprise levels. At each stage, inspect what must be true first, what stuck looks like, what proves progress, and what the next capability unlocks, then use that view to choose a viable next move.",
