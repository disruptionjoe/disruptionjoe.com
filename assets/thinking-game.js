(function () {
  ...
  var exhibits = [
    ...
    },
    {
      ...
      mobilePurpose: "I use this site as the public front door to my practice. It connects what I offer, how I work, what I am testing, and where a visitor should go next.",
      mobilePassion: "I built the site to evolve with the practice. When an offer, method, or proof point changes, the public experience can change with it instead of becoming a stale brochure.",
    ...
    },
    {
      ...
      mobilePurpose: "I am researching rules that could reward informed, opt-in participation while expanding authority without sacrificing coherence or capture resistance. Purity Protocol is not a live protocol, pilot, or incentive system.",
      mobileDirectLink: true,
      mobileLinkLabel: "View on GitHub",
      mobileLinkTarget: "_blank",
      mobileHideDirectHint: true,
    ...
    },
    {
      ...
      mobilePurpose: "I keep the legal, financial, administrative, and secure-information context required to operate the practice responsibly.",
      mobilePassion: "Required records, responsibilities, and decisions stay organized, while anything outside the system's authority is routed to the person or process that owns it.",
      mobileRevealLabel: "See How I Use It",
      mobileHideDirectHint: true,
    ...
    },
    {
      ...
      mobilePurpose: "I use X to trade notes with people advancing their craft, share observations before they become articles, and follow questions that simply interest me.",
      mobileDirectLink: true,
    ...
    },
    {
      ...
      mobilePurpose: "Read my publications and dated public record behind the questions in this hall.",
